...
Sukprasert et al. \cite{sukprasert_limitations_2024} argue that the average carbon intensity used by most carbon-aware systems, including LiteCast, is not the right signal in all settings, because the marginal generator that responds to demand shifts is not always the average generator and the resulting carbon savings may differ from those predicted by average intensity. 
