...
The existing forecasting literature treats this as an accuracy problem and optimizes its models against MAPE. However, the scheduler's decision is fundamentally an ordering problem: given a window of candidate hours or regions, the scheduler picks whichever has the lowest predicted emissions.
