...
\caption{The $48$ regions used in the evaluation, sorted by mean carbon intensity. Mean CI is in $\text{g}\cdot\text{CO}_2\text{eq}/\text{kWh}$. CV is the coefficient of variation ($\sigma/\mu$) over 2023.}
