...
\begin{figure}[h]
    ...
    \caption{Comparing inaccuracy versus misalignment for a 3-hour continuous job on the ERCOT grid over a 24-hour window. The schedule S5 using a high-MAPE but high-concordance forecast matches the oracle's schedule of S1; The schedules S2-S4 schedules using low-MAPE forecasts with degraded concordance pick increasingly suboptimal schedules. 
    }
...
SARIMAX has two properties that align with the design principles above.
