...
\begin{figure}[h]
    ...
    \caption{Comparing inaccuracy versus misalignment for a 3-hour continuous job on the ERCOT grid over a 24-hour window. Schedule S5, using a high-MAPE yet high-concordance forecast, matches the oracle schedule S1; schedules S2--S4, using low-MAPE forecasts with degraded concordance, pick increasingly suboptimal start times.}
